...
Space.prototype.updateDatabase = function(name, price, description, startdate, enddate, pretendID) {
  console.log("INSERT INTO spaces (name, price, description, startdate, enddate, landlordid) VALUES ('"+name+"', "+price+", '"+description+"', '"+startdate+"', '"+enddate+"', "+pretendID+");")
  // client.query("INSERT INTO spaces (name, description, price, startdate, enddate, landlordid) VALUES ('"+ name +","+ "+description+"+","+ price+","+startdate+","+enddate+","+pretendID+"');")
