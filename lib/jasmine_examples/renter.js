...
// client.query("INSERT INTO renter (name) VALUES ('James Lewis');", (err, res) => {
//     client.end()
// })
...
Renter.prototype.addName = function(name){
    var dave = "INSERT INTO renter (name) VALUES ('"+name+"');";
    client.query(dave, (err, res) => {
        client.end()
    })

    // client.query('SELECT * FROM renter', (err, res) => {
    //     console.log(res)
